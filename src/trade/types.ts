import {
  ...
  TizzTradingStorage,
} from "../contracts/types/generated";
...
export type LimitOrderRaw = TizzTradingStorage.OpenLimitOrderStructOutput & {
  type: number;
...
export type TradeContainerRaw = {
  trade: TizzTradingStorage.TradeStruct;
  tradeInfo: TizzTradingStorage.TradeInfoStruct;
  tradeData: ITizzTradingCallbacks.TradeDataStruct;
  initialAccFees: {
    borrowing: {
      accPairFee: number;
      accGroupFee: number;
