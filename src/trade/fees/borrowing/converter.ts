import { ITizzBorrowingFees } from "../../../contracts/types/generated/core/TizzBorrowingFees";
import { BorrowingFee } from ".";

export const convertPairGroupBorrowingFee = (
  pairGroup: ITizzBorrowingFees.PairGroupStructOutput
...
export const convertPairBorrowingFee = (
  pair: ITizzBorrowingFees.PairStructOutput,
  pairOi: ITizzBorrowingFees.PairOiStructOutput
): BorrowingFee.Pair => ({
...
export const convertPairBorrowingFees = ([pairs, pairOi]: [
  ITizzBorrowingFees.PairStructOutput[],
  ITizzBorrowingFees.PairOiStructOutput[]
]): BorrowingFee.Pair[] =>
  pairs.map((value, ix) => convertPairBorrowingFee(value, pairOi[ix]));

export const convertGroupBorrowingFee = (
  group: ITizzBorrowingFees.GroupStructOutput,
...
export const convertGroupBorrowingFees = ([groups, groupFeeExponents]: [
  ITizzBorrowingFees.GroupStructOutput[],
  number[]
]): BorrowingFee.Group[] =>
  groups.map((value, ix) =>
